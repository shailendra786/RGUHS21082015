									...
									<table
										...
										<tbody>
											<%
												int i = 1;
											%>
											<s:iterator value="allChallanInfo">
												<tr>
													<%-- <td><span style="margin-left: 10px;"><%=i%></span></td>
                                                    <tr> --%>
												<td><span style="margin-left: 10px;"><s:property value="challanId" /></span></td>
												<td><span style="margin-left: 10px;"><s:property
														value="dateOfTransaction" /></span></td>
												<td><span style="margin-left: 10px;"><s:property value="transactionId" /></span></td>
												<td><span style="margin-left: 10px;"><s:property value="amount" /></span></td>
												<td><span style="margin-left: 10px;"><s:property
														value="studentEnrollmentNumber" /></span></td>
												<td><span style="margin-left: 10px;"><input type="button" value="View" onclick='window.open("serachByChallanNumber?challanNum=<s:property value="challanId"/>", "CollegeForm", "width=500,height=700")'>
														</span></td>
