									...
									<table class="table table-condensed">
										...
										<tbody>
											<tr>
												...
												<td><s:property value="affInstBean.place" /></td>
											...
											<tr>
												...
												<td><s:property value="affInstBean.contactPerson" /></td>

											</tr>
											<tr>

												<td style="font-weight: bold;">Telephone Number</td>
												<td><s:property value="affInstBean.contactNumber" /></td>

											</tr>
											<tr>

												<td style="font-weight: bold;">Mobile Number</td>
												<td><s:property value="affInstBean.mobileNum" /></td>
