							...
							<div class="box-content row">
								<div class="col-lg-12 col-md-12 animated fadeIn">
									...
									<table
										...
										<tbody>
											<tr>
												<td><s:property value="challanDetails.challanId" /></td>
												<td><s:property
														value="challanDetails.dateOfTransaction" /></td>
												<td><s:property value="challanDetails.transactionId" /></td>
												<td><s:property value="challanDetails.amount" /></td>
												<td><s:property
														value="challanDetails.studentEnrollmentNumber" /></td>
											</tr>
										</tbody>
									</table>
