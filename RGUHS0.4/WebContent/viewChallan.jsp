                                 ...
                                 <table class="table table-condensed">
										...
										<tbody>
											<tr>
												...
												<td><strong>ChallanNumber</strong></td>
												<td><div id="the-basics" class="has-success">
															<s:property value="challanDetails.challanId" />								
											...
											<tr>
												...
												<td><div id="the-basics" class="has-success">
														<s:property
														value="challanDetails.dateOfTransaction" />
											...
											<tr>
												...
												<td><div id="the-basics" class="has-success">
														<s:property value="challanDetails.transactionId" />
													</div></td>
											...
											<tr>
												...
												<td><div id="the-basics" class="has-success">
														<s:property value="challanDetails.amount" />
											...
											<tr>
												...
												<td><strong>Students EnrollMent</strong></td>
												<td><div id="the-basics" class="has-success">

														<s:property
														value="challanDetails.studentEnrollmentNumber" />
													</div></td>
